...
import java.util.*;
public class RandRdriver implements Serializable {
	public static void main (String args[]){
		RandRTree tree = new RandRTree();
	...
	public static void getInput(RandRTree tree){
	...
	public static void checkIfPossible(RandRTree tree) {
