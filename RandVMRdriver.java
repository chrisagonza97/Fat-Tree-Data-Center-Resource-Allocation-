...
import java.util.*;
public class RandVMRdriver implements Serializable {
	public static void main (String args[]){
		RandVMRs tree = new RandVMRs();
	...
	public static void getInput(RandVMRs tree){
	...
	public static void checkIfPossible(RandVMRs tree) {
