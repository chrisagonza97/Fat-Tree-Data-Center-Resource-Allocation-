...
import java.util.*;
public class RandMsdriver implements Serializable {
	public static void main (String args[]){
		RandMTree tree = new RandMTree();
		getInput(tree);//getting user input
		tree.buildTree();//building the tree
		checkIfPossible(tree);
	...
	public static void getInput(RandMTree tree){
	...
	public static void checkIfPossible(RandMTree tree) {
